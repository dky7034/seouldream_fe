        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="min-w-0">
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2 truncate">
              <UserIcon className="h-7 w-7 text-indigo-500 flex-shrink-0" />
              ...
              <table className="min-w-full divide-y divide-gray-200 text-sm">
                <thead className="bg-gray-50/50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left font-bold text-gray-500 uppercase text-xs w-40 whitespace-nowrap">
                      작성자
                    </th>
